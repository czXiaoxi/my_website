...
<!--文件体开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/orderinfo.info?orderid=1">${order.orderid }</a></td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${order.cost }</td>
			<td class=tablebody1 valign=middle align=center width="">${order.orderstatus.name }</td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${order.payway.paystyle } </td>
			<td class=tablebody1 valign=middle align=center width="">
			<input type="button" value="删除" onclick="javascript:window.location='RemoveOrderServlet?orderid=${order.orderid }';">&nbsp;<input type="button" value="明细" onclick="javascript:window.location='OrderDetailServlet?orderid=${order.orderid }';"><!--&nbsp;<input type="button" value="修改"/>--> </td>
		</tr>
         </c:forEach>       
