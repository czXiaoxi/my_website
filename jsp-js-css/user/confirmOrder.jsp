...
<!--文件尾开始-->
		...
		<tr>
			...
			<td width="60%" class="tablebody1">
                          ...
                          <c:forEach items="${sessionScope.payways }" var="payway">
		                          	<option value="${payway.value.paywayid }">${payway.value.paystyle }</option>
                          </c:forEach>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="ProductDetailServlet?productid=${orderline.product.productid }" target="_blank">${orderline.product.name }</a></td>
