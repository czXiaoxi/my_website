...
<!--文件体开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="ProductDetailServlet?productid=${orderline.product.productid }">${orderline.product.name }</a></td>
			...
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;${(orderline.product.baseprice)*(orderline.amount) }</td>
			<td class=tablebody1 valign=middle align=center width="">
			<input type="button" value="删除" onclick="javascript:window.location='RemoveProductServlet?productid=${orderline.product.productid }';"> <input type="submit" value="保存修改"></td>
			</form>
		</tr>
        </c:forEach>        
		...
		<tr>
			<td class=tablebody2 valign=middle align=center colspan="6"><input type="button" value="提交订单" onclick="javascript:window.location='user/confirmOrder.jsp';"> 
			<input type="button" value="继续购物" onclick="javascript:window.location='index.jsp';"> <input type="button" value="清空购物车" onclick="javascript:window.location='removeAllProduct.action';"></td>
		</tr>
                </table><br>
<!--文件尾开始-->
