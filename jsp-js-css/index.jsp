...
<!--文件体开始-->
        ...
        <c:forEach items="${applicationScope.products }" var="product">
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="ProductDetailServlet?productid=${product.value.productid }">${product.value.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${product.value.baseprice}</td>
			<td class=tablebody1 valign=middle align=center width=""><a href="AddShopcartServlet?productid=${product.value.productid }">
